<template>
  ...
  >
    ...
    <el-form-item label="描述 Description">
      <el-input type="textarea" :rows="2" v-model="formData.textarea" placeholder="請輸入">
      </el-input>
    </el-form-item>
