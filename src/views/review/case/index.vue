          ...
          <div class="baseinfo-card">
            <el-form ref="caseForm" :model="formData" :rules="rules" class="baseinfo-form" label-width="220px">
              ...
              <el-form-item label="物業 Property">
                <el-select v-model="formData.caseType" size="small" filterable clearable style="width: 100%" placeholder="請選擇">
              ...
              <el-form-item label="聯絡人 Contact Person">
                <el-select v-model="formData.contactPerson" size="small" filterable clearable style="width: 100%" placeholder="請選擇">
                  <el-option v-for="item in propertyList" :key="item.id" :label="item.name" :value="item.id"></el-option>
                </el-select>
              </el-form-item>
...
<script>
import { originList, courseClassifyListCopy, subjectList, priority, caseTypeList, propertyList, locationList } from '@/views/confirm/case/index'
